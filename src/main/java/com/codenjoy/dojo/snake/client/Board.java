...
public class Board extends AbstractBoard<Elements> {
    ...
    public Map<String,Point> getHead(String zero) {
        Map<String,Point> resultMap = new HashMap<>();
        String headDirection = "UP";
        Elements headUp = Elements.HEAD_UP;
        Elements headDown = Elements.HEAD_DOWN;
        Elements headLeft = Elements.HEAD_LEFT;
        Elements headRight = Elements.HEAD_RIGHT;
        if(headDown != null){
            headDirection = "DOWN";
        }else if(headLeft != null){
            headDirection = "LEFT";
        }else if(headRight != null){
            headDirection = "RIGHT";
        }else{
            //nothing todo
        }
        ...
        if (result.isEmpty()) {
            ...
            resultMap.put(headDirection,result.get(0));
            return resultMap;
        }
    }
